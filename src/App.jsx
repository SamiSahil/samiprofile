...
// --- Data ---
const PROJECTS = [
  { title: "AlgoViz — Visualizing classic algorithms", impact: "Helped students understand sorting/pathfinding with interactive visuals.", stack: ["TypeScript", "Next.js", "Tailwind CSS", "D3"], github: "https://github.com/SamiSahil/AlgoViz", demo: "https://github.com/SamiSahil/AlgoViz", image: projectAlgoViz },
  { title: "Campus Navigator", impact: "Real-time building search and indoor paths.", stack: ["React Native", "Mapbox", "Node.js"], github: "https://github.com/SamiSahil/CampusNavigator", demo: "https://github.com/SamiSahil/CampusNavigator", image: projectCampusNav },
  { title: "CleanSheet — Minimal task manager", impact: "Fast offline-first productivity app.", stack: ["PWA", "Next.js", "Prisma", "Postgres"], github: "https://github.com/SamiSahil/CleanSheet", demo: "https://github.com/SamiSahil/CleanSheet", image: projectCleanSheet },
];
const SKILLS = {
  Languages: ["TypeScript", "JavaScript", "Python", "C++", "HTML", "CSS"],
  Frontend: ["React", "Next.js", "Tailwind CSS", "Framer Motion", "D3.js"],
...
const EXPERIENCE = [
  { title: "Third-year B.Sc. in Computer Science & Engineering", org: "Uttara University", dates: "2022 - Present", impact: ["Engaged in core computer science topics including data structures, algorithms, and software engineering principles.", "Participated in multiple university-level programming contests and hackathons."] },
];
const ACHIEVEMENTS = [
  { title: "1st Place, University Hackathon", org: "Uttara University", description: "Developed a real-time collaborative code editor in 24 hours." },
  { title: "Certificate: Machine Learning", org: "Coursera", description: "Completed Andrew Ng's foundational machine learning course." },
];
    ...
    <div className="px-2 py-10 sm:py-16 sm:px-4">
      ...
      <div className="grid items-start max-w-6xl grid-cols-1 gap-12 mx-auto lg:grid-cols-2">
        ...
        <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2, ease: "easeOut" }}>
          ...
          <div className="flex flex-wrap mb-8 font-medium gap-x-6 gap-y-3 text-textLight dark:text-textDark">
            <span><strong className="text-primary">5+</strong> years of experience</span>
            <span><strong className="text-primary">40+</strong> projects shipped</span>
            <span><strong className="text-primary">100%</strong> client satisfaction</span>
          </div>
          <div className="grid grid-cols-2 gap-8">
            <StatItem value="120" label="Happy Clients" />
            <StatItem value="85" label="Completed Projects" />
          </div>
        </motion.div>
      </div>
    </div>
...
const SKILL_BARS = [
  { skill: "TypeScript", percent: 90 }, { skill: "React", percent: 85 }, { skill: "Next.js", percent: 80 },
...
const Achievements = () => (
  <AnimatedSection id="achievements">
    <div className="py-16">
      <h2 className="mb-12 text-4xl font-extrabold text-center font-jakarta text-textLight dark:text-textDark">Achievements</h2>
      <div className="grid max-w-4xl grid-cols-1 gap-8 mx-auto md:grid-cols-2">
        {ACHIEVEMENTS.map((item, i) => (
          <div key={i} className="p-6 rounded-2xl shadow-lg bg-surfaceLight dark:bg-surface border border-gray-200 dark:border-[#1C2026]">
            <h3 className="mb-1 text-xl font-bold font-jakarta text-textLight dark:text-textDark">{item.title}</h3>
            <p className="mb-2 text-sm text-mutedLight dark:text-muted">{item.org}</p>
            <p className="text-mutedLight dark:text-muted">{item.description}</p>
          </div>
        ))}
      </div>
    </div>
